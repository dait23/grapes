...
renderAction(){
 ...
 if(this.props.post.publishing.user.id == window.localStorage.getItem('uid')){
  ...
  return(
    ...
    <div>
        ...
        <span className="pull-right"  style={{fontSize:'14px', marginLeft:'10px', cursor:'pointer'}} onClick={this.handleDelete} >Delete</span>
                     <span className="pull-right"  style={{fontSize:'14px'}} ><a href={`/me/publication/draft-story/edit/${this.props.post.id}`}>Edit</a></span>
