  ...
  render() {
    ...
    return (
            ...
            <div>
              ...
              {this.props.inter.topics.map((topic) => (
              ...
              <div className="col-xs-12">
                <div className="main-title">
                  ...
                  <div className="pull-right" style={{marginTop:'40px', textTransform:'capitalize', fontSize:'13px'}}><a href={`/topic/${topic.slug}`}>View All</a></div>
                </div>
