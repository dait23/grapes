                  ...
                  <div className="new-content">
                    ...
                    <div className="post-author-info-top">
                     <div className="main-title" style={{marginBottom:'70px'}}>
                         ...
                         <Image style={{float:'left', marginRight:'5px'}} cloudName={Cloudinary_Name} publicId={this.state.avatarId}  crop="scale"  width="50" height="50" alt="cover"/> <h4><strong>{this.state.name}</strong> New Storie </h4>
                     </div>
