...
class StatPublish extends Component {
      ...
      <div>
       ...
       <div className="candy-wrapper">
          <div className="main">
            ...
            <div className="col-md-9">
                <div className="main-title">
                  <h4><strong>{this.state.name}</strong> Publish </h4>
                   <div className="pull-right" style={{marginTop:'40px', textTransform:'capitalize', fontSize:'13px'}}><Link to={`/me/publication/stats-draft/${this.state.id}`}>Draft</Link></div>
                </div>
