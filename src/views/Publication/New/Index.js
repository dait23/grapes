...
renderTopics(){
  ...
  render() {
   ...
   handlePost = async () => {
    ...
    const { name, slug, description, avatarId, avatarUrl, topicsIds, coverId, coverUrl, email, facebook, twitter, instagram, writtersIds } = this.state
  
    await this.props.createPublishMutation({variables: { name, slug, description, avatarId, avatarUrl, topicsIds, coverId, coverUrl, email, facebook, twitter, instagram, userId, writtersIds }})
