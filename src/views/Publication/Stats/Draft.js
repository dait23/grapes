...
class StatDraft extends Component {
...
renderList(){
  ...
  if(this.props.data.allPosts == ''){
    ...
    return(
         ...
         <p>No Storie Yet !!!</p>
         <br />
           <Link to={`/me/publication/new-story/${this.state.id}`}  style={{margin:'5px 0px', fontSize:'14px', border:'1px solid #333', padding:'10px', textDecoration:'none'}} alt="Add new storie"><i className="far fa-edit" style={{fontSize:'20px'}}></i>&nbsp;&nbsp; New Storie</Link>
         </div>
      ...
      <div>
       ...
       <div className="candy-wrapper">
          <div className="main">
            ...
            <div className="col-md-9">
                <div className="main-title">
                  <h4><strong>{this.state.name}</strong> Draft </h4>
                   <div className="pull-right" style={{marginTop:'40px', textTransform:'capitalize', fontSize:'13px'}}><a href={`/me/publication/stats-publish/${this.state.id}`}>Publish</a></div>
                </div>
