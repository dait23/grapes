  ...
  render () {
    ...
    return (     
           ...
           <div className="post-type-newyork">
              <figure className="post-image"> <Image cloudName={Cloudinary_Name} publicId={this.props.post.imageId}  gravity="center" width="135" height="135" crop="thumb"  alt={this.props.post.title}/></figure>
