 ...
 onImageCoverDrop(files) {
  ...
  render() {
   ...
   handlePost = async () => {
    ...
    const { id, name, slug, description, avatarId, avatarUrl, topicsIds, coverId, coverUrl, email, facebook, twitter, instagram } = this.state
  
    await this.props.createPublishMutation({variables: { id, name, slug, description, avatarId, avatarUrl, topicsIds, coverId, coverUrl, email, facebook, twitter, instagram, userId }})
